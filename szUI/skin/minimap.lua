...
local font, size, flags = MinimapZoneText:GetFont()
MinimapZoneText:SetFont(szUI.ui.minimap.font, szUI.ui.minimap.fsize, flags)
...
a:Hide()
a = TimeManagerClockButton:CreateTexture(nil, "BORDER")
a:SetAllPoints(TimeManagerClockButton)
...
font, size, flags = TimeManagerClockTicker:GetFont()
TimeManagerClockTicker:SetFont(szUI.ui.minimap.font, size+2, flags)
TimeManagerClockTicker:SetPoint("CENTER", TimeManagerClockButton, "CENTER", 1, 0)
CreateBorder(TimeManagerClockButton,12, 0,0,0,2,2,2,2,2,0,2,0,true,false)
...
mappos.texture:SetTexture(0,0,0,1)
